...
\newcommand{\msctitle}{\textbf{MSc. Bioinformatics}}
...
\newcommand{\Utilities}{grep, awk, git, ssh, cut, tee, find, sed, wget, ln, vim, kill, ps, top, time.}
...
\newcommand{\Binflogo}{\includegraphics[height=20pt]{images/binf_logo.jpg}}



\newcommand{\Topics}{\begin{tabular}[c]{@{}l@{}}RNA-seq, ChIP-seq, RNA-seq \textit{de novo}, gene networks, database search, \\ structure visualization and prediction, molecular simulations.\end{tabular}}
\newcommand{\Software}{
\begin{tabular}[c]{@{}l@{}}BLAST, HMMER, MEME, Cytoscape, MACS, PeakAnalyzer,\\ Tuxedo protocol, GATK, bwa, samtools, Scipio, COPASI.\end{tabular}}
\newcommand{\binflevel}{\begin{tabular}[t]{@{}c@{}}Graduate\\ level\end{tabular}}
...
\SkillsEntry{Spanish}{\textbf{Native}}
\sepspace
