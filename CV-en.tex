...
\newcommand{\CRAN}{\textbf{Other packgs}: igraph, knitr, openxlsx, seqinr.}
...
\newcommand{\Utilities}{\textbf{Utilities}: grep, awk, git, ssh, cut, tee, find, sed, wget, ln, vim, kill, ps, top, time.}
\newcommand{\Methods}{\textbf{Methods}: IO redirection, reverse search, wildcards, pipelining, sys admin.}
\newcommand{\Scripting}{\textbf{Scripting}: for, while, if, input parameters, parallelization. SGE clusters.}
\newcommand{\Binflogo}{\includegraphics[height=20pt]{images/binf_logo.jpg}}



\newcommand{\Topics}{\begin{tabular}[c]{@{}l@{}}\textbf{Topics}: RNA-seq, ChIP-seq, RNA-seq \textit{de novo}, structure visualization and prediction,\\  gene networks, molecular simulations, database search.\end{tabular}}
\newcommand{\Software}{
\begin{tabular}[c]{@{}l@{}}\textbf{Software}: BLAST, HMMER, MEME, Cytoscape, MACS, PeakAnalyzer, Tuxedo protocol,\\ GATK, bwa, samtools, Scipio, COPASI.\end{tabular}}
...
%\textit{English} & Advanced     & Advanced     & Proficient    \\
%\textit{French}  & Intermediate & Intermediate & Intermediate  \\
%\textit{Danish}  & \multicolumn{3}{l}{Studying A1 level at KU}
%\end{tabular}
%\end{table}		
